...
def test_get_assignments_in_graded_state_for_each_student(test_client, init_database):
...
def test_get_grade_A_assignments_for_teacher_with_max_grading(test_client, init_database):
